...
class Env(object):
    ...
    def _set_changeable_variable(self, changeable_variable): raise NotImplementedError

    # Do not override
    _owns_render = True

    def set_changeable_variable(self, changeable_variable):
        return self._set_changeable_variable(changeable_variable=changeable_variable)
