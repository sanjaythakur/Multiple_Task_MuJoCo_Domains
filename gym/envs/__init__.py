...
register(
    id='Modified-CartPole-v0',
    entry_point='gym.envs.classic_control:ModifiedCartPoleEnv',
    max_episode_steps=200,
    reward_threshold=195.0,
)

register(
    id='Modified-CartPole-v1',
    entry_point='gym.envs.classic_control:ModifiedCartPoleEnv',
    max_episode_steps=500,
    reward_threshold=475.0,
)
...
register(
    id='Modified-Pendulum-v0',
    entry_point='gym.envs.classic_control:ModifiedPendulumEnv',
    max_episode_steps=200,
    reward_threshold=-110.0,
)
...
register(
    id='Swimmer_1-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_1',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_2-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_2',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_3-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_3',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_4-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_4',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_5-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_5',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_6-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_6',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_7-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_7',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_8-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_8',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
...
register(
    id='Swimmer_9-v1',
    entry_point='gym.envs.mujoco:SwimmerEnv_9',
    max_episode_steps=1000,
    reward_threshold=360.0,
)
